...
function shop_isle_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'shop_isle_news_section' , array(
		'title'       => __( 'News section', 'shop-isle' ),
		'priority'    => 43,
		'panel' => 'shop_isle_front_page_sections'
	));

	/* Hide news */
	$wp_customize->add_setting( 'shop_isle_news_hide', array(
		'transport' => 'postMessage',
		'sanitize_callback' => 'shop_isle_sanitize_text'
	));
	...
	$wp_customize->add_control(
		...
		array(
			'type' => 'checkbox',
			'label' => __('Hide news section?','shop-isle'),
			'description' => __('If you check this box, the News section will disappear from homepage.','shop-isle'),
			'section' => 'shop_isle_news_section',
			'priority'    => 1,
		)
	);
	
	/* Explain where the text is drawn from */
	$wp_customize->add_setting( 'shop_isle_news_info', array(
		'transport' => 'postMessage',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control(
		'shop_isle_news_info', array(
			'type' => 'hidden',
			'label' => __('Where these posts come from:','shop-isle'),
			'description' => __("These are the two most recent posts that have been tagged 'news'. "),
			'section' => 'shop_isle_news_section',
			'priority'    => 1,
		)
	);
	...
	$wp_customize->add_section( 'shop_isle_about_section' , array(
		'title'       => __( 'About section', 'shop-isle' ),
		'priority'    => 44,
		'panel' => 'shop_isle_front_page_sections'
	));

	/* Hide about */
	$wp_customize->add_setting( 'shop_isle_about_hide', array(
		'transport' => 'postMessage',
		'sanitize_callback' => 'shop_isle_sanitize_text'
	));

	$wp_customize->add_control(
		'shop_isle_about_hide',
		array(
			'type' => 'checkbox',
			'label' => __('Hide about section?','shop-isle'),
			'description' => __('If you check this box, the About section will disappear from homepage.','shop-isle'),
			'section' => 'shop_isle_about_section',
			'priority'    => 1,
		)
	);
	
	/* Change Google Map's Info */
	$wp_customize->add_setting( 'shop_isle_about_google_map', array(
		'transport' => 'postMessage',
		'default' => __( 'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d6186.631917805118!2d-86.53285885512835!3d39.16753730433378!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x886c66c2daf4a4a30x3b0fc9814dd6a62b!2s408+E+6th+St+Bloomington+IN+47408!5e0!3m2!1sen!2sus!4v1482877862643', 'shop-isle'),
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control(
		'shop_isle_about_google_map', array(
			'type' => 'text',
			'label' => __('Paste Google Maps iframe here','shop-isle'),
			'description' => __("This is where you put the Google Maps embed URL. Don't post all the other \<iframe\> stuff, just the URL that comes after src='..."),
			'section' => 'shop_isle_about_section',
			'priority'    => 1,
		)
	);
	/* Explain where the text is drawn from */
	$wp_customize->add_setting( 'shop_isle_about_info', array(
		'transport' => 'postMessage',
		'sanitize_callback' => 'sanitize_text_field'
	));
	$wp_customize->add_control(
		'shop_isle_about_info', array(
			'type' => 'hidden',
			'label' => __('Hours + Other Text','shop-isle'),
			'description' => __("All of the text to the right of the map is from the page text. Just hit 'Edit Page' in the top bar to change it."),
			'section' => 'shop_isle_about_section',
			'priority'    => 1,
		)
	);
	...
	$wp_customize->add_section( 'shop_isle_big_banners_section' , array(
		'title'       => __( 'Big banners section', 'shop-isle' ),
		'priority'    => 45,
		'panel' => 'shop_isle_front_page_sections'
	));

	/* Hide banner */
	$wp_customize->add_setting( 'shop_isle_big_banners_hide', array(
		'transport' => 'postMessage',
		'sanitize_callback' => 'shop_isle_sanitize_text'
	));

	$wp_customize->add_control(
		'shop_isle_big_banners_hide',
		array(
			'type' => 'checkbox',
			'label' => __('Hide big banners section?','shop-isle'),
			'description' => __('If you check this box, the Big Banners section will disappear from homepage.','shop-isle'),
			'section' => 'shop_isle_big_banners_section',
			'priority'    => 1,
		)
	);

	$wp_customize->add_setting( 'shop_isle_big_banners_title', array(
		'transport' => 'postMessage',
		'sanitize_callback' => 'shop_isle_sanitize_text'
	));

	$wp_customize->add_control( 'shop_isle_big_banners_title', array(
		'label' => __( 'Section title', 'shop-isle' ),
		'section' => 'shop_isle_banners_section',
		'priority' => 2,
	));
	...
	/* Banner */
	$wp_customize->add_setting( 'shop_isle_big_banners', array(
		'transport' => 'postMessage',
		'sanitize_callback' => 'shop_isle_sanitize_repeater',

		'default' => json_encode(array( array('image_url' => get_template_directory_uri().'/assets/images/bigbanner.jpg' ,'link' => '#' ) )) 
	));
	$wp_customize->add_control( new Shop_Isle_Repeater_Controler( $wp_customize, 'shop_isle_big_banners', array(
		'label'   => __('Add new big banner','shop-isle'),
		'section' => 'shop_isle_big_banners_section',
		'priority' => 3,
        'shop_isle_image_control' => true,
        'shop_isle_link_control' => true,
		...
		'shop_isle_icon_control' => false,
		'shop_isle_description_control' => false,
		'shop_isle_box_label' => __('Big Banner','shop-isle'),
		'shop_isle_box_add_label' => __('Add new big banner','shop-isle')
	) ) );
